...
const LineTOS = ({ isActive }) => (
  <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
    ...
    <rect x="55" y={isActive ? 50 : 30} width="30" height="15" className={isActive ? "fill-teal-500" : ""} style={{ transition: 'all 2s' }} />
  </svg>
);
...
const App = () => {
  ...
  const steps = [
    ...
    { title: 'TOS', sub: 'Terminal', icon: LineTOS, color: 'text-teal-600', bg: 'bg-teal-50' },
    ...
    { title: 'TMS', sub: 'Store', icon: LineStore, color: 'text-rose-600', bg: 'bg-rose-50' }
  ];
